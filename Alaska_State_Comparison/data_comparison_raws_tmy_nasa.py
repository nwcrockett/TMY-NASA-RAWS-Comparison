...
between TMY, Meso West, and NASA POWER data sets
...
def preprocess_data(df_raws, df_tmy, df_nasa):
    ...
    :param df_nasa: Initial NASA POWER dataset
...
def output_difference_data(tmy_direct, tmy_path, meso_direct, meso_path, nasa_path, time_df):
    """
    This Function will take in the path names and lists of file names for all of the tmy, meso west, and nasa
    solar files with tmy and meso west weather stations that are within a predetermined distance to one another.
    It will then calculate the average difference between tmy, meso west, and nasa power by year. Following that the
    average difference between the datasets by each of the months in a year. The results of this are outputted to
    a DataFrame that is then written to a csv file.


    :param tmy_direct: list of files in the tmy directory
    :param tmy_path: path to the tmy directory
    :param meso_direct: list of files in the Meso West directory. Also used for filenames in the NASA POWER directory
    :param meso_path: path to the Meso West directory
    :param nasa_path: path to the Nasa Directory
    :param time_df:
...
if __name__ == "__main__":
    ...
    tmy_path_for_raws_comparison = "/home/nelson/PycharmProjects/" \
                                   "TMY_NASA_RAWS Comparison/Alaska_State_Comparison/TMY3 Alaska"
    nasa_path_for_raws_comparison = "/home/nelson/PycharmProjects/" \
                                    "TMY_NASA_RAWS Comparison/Alaska_State_Comparison/NASA POWER data Meso Comp"
    ...
    output_difference_data(tmy, tmy_path_for_raws_comparison,
                           meso, meso_path,
                           nasa,
                           time_df)
